      ...
      <section id="main-content">
          <section class="wrapper">
            ...
            <?php
              ...
              if(isset($_GET["MovedToDelivered"])){
                  echo '<h1 class="blue text-center"> Forwarded to Delivered Successfully! </h1>';
              }
                            ...
                            <thead class="TableHead">
                              ...
                              <tbody>
                                 ...
                                 <td class="numeric">'.$Data["Name"].'</td>
                                     ...
                                     <td class="numeric"> <a href="OrdersInProgress.php?pid='.$Data["Id"].'" style="background:none !important">View Products </td>
                                   ...
                                   <td class="numeric">'.$Data["Payment_Method"].'</td>
                                     ...
                                     <td class="numeric">'.$Data["Status"].'</td>
                                      ...
                                      <td class="numeric">
                                       ...
                                       <a href="../Admin.php?moveD='.$Data["Id"].'"class="icon" style="background:none !important"> <span class="glyphicon glyphicon-share-alt" title="Forward"></span></a>
                                       <a href="../Admin.php?deleteOrder='.$Data["Id"].'&Page=OrdersInProgress" class="icon" style="background:none !important"> <span class="glyphicon glyphicon-trash" title="Delete"></span></a>
