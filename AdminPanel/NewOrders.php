      ...
      <section id="main-content">
          <section class="wrapper">
             <?php
              ...
              if(isset($_GET["MovedToProcess"])){
                  echo '<h1 class="blue text-center"> Forward Successfully </h1>';
              }
                            ...
                            <table class="table table-bordered table-striped table-condensed paginated">
                              ...
                              <tbody>
                                 ...
                                 $Connection = $C->Connect();
                                  ...
                                  $Query = "Select *from orders where Status = 'New Arrived' ";
                                  ...
                                  <td class="numeric">'.$Data["Name"].'</td>
                                      ...
                                      <td class="numeric"> <a href="NewOrders.php?pid='.$Data["Id"].'" style="background:none !important">View Products </td>
                                    ...
                                    <td class="numeric">'.$Data["Payment_Method"].'</td>
                                      ...
                                      <td class="numeric">'.$Data["Status"].'</td>
                                       ...
                                       <td class="numeric">
                                        ...
                                        <a href="../Admin.php?moveP='.$Data["Id"].'"class="icon" style="background:none !important"> <span class="glyphicon glyphicon-share-alt" title="Forward"></span></a>
                                        <a href="../Admin.php?deleteOrder='.$Data["Id"].'&Page=NewOrders" class="icon" style="background:none !important"> <span class="glyphicon glyphicon-trash" title="Delete"></span></a>
