          ...
          <section class="wrapper">
              ...
              <h3 style="text-align:center"> Search Customer</h3>
                  ...
                  <div class="input-group">
		  		    ...
		  		    <input type="text" name="SearchCustomer" placeholder="Enter Name" class="form-control">
                                  ...
                                  if($Result){
                                      ...
                                      while($Data = mysqli_fetch_assoc($Result)){
                                       ...
                                       <td class="numeric">
                                        ...
                                        <a href="../Admin.php?deleteC='.$Data["Id"].'&Page=SearchCustomer"  style="background:none !important" class="icon"> <span class="glyphicon glyphicon-trash"></span></a>
