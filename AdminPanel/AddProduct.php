		...
		<div class="form-v5-content">
			<form class="form-detail" action="../Admin.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-row">
					...
					<input type="file" placeholder="Upload PrimaryImage" name="PrimaryImage" id="PrimaryImage" class="input-text">
				</div>
				<div class="form-row">
					<label for="SecondaryImage">Secondary Image</label>
					<input type="file" placeholder="Upload Secondary Image" name="SecondaryImage" class="input-text" id="SecondaryImage">
				</div>
				<div class="form-row">
					<label for="BrandIcon">Brand Icon</label>
					<input type="file" placeholder="Upload Secondary Image" name="BrandIcon" class="input-text" id="BrandIcon">
				</div>
